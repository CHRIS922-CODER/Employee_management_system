...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('Admin', '0008_remove_department_roles_alter_employee_role'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Admin.roles')),
                ('task', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Admin.tasks')),
